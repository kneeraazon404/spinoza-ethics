    ...
    return (
        <div className="w-full h-full p-8 md:p-12 overflow-y-auto bg-white rounded-2xl">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="space-y-12 font-serif text-lg leading-relaxed text-slate-700">
                    {/* Section 1: Why */}
                    <section>
                        <h3 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2 border-slate-200">Why I Built This</h3>
                    ...
                    {/* Section 2: How Built */}
                    <section>
                        <h3 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2 border-slate-200">How It&apos;s Built</h3>
                        <p className="text-slate-700 text-justify mb-4">
                    ...
                    <section>
                        <h3 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2 border-slate-200">How to Navigate</h3>
                        <p className="text-slate-700 text-justify mb-4">
                    ...
                    <section className="bg-slate-50 p-8 rounded-xl border border-slate-200 mt-12">
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">Your Feedback</h3>
                        <p className="text-slate-700 text-justify mb-4">
                        ...
                        <p className="text-slate-700 font-medium">
                            Please reach out with your thoughts, queries, or suggestions at <a href="mailto:kneeraazon@gmail.com" className="text-indigo-600 hover:underline decoration-indigo-300 underline-offset-2">kneeraazon@gmail.com</a>. Let&apos;s decode the Ethics together!
                        </p>
                    </section>
                </div>
            </div>
